...
void drawScene(int scene) {
    ...
    float scaleToScreen = -g_windowHeight/tan(((g_phi/360)*2*M_PI)/2);
...
void initCustomResources() {
    ...
    // Initialize shaders:
    g_simplePointShader = new ShaderProgram("scene1_293370.vsh", "scene1_293370.fsh");
    ...
    g_ssSplatShader = new ShaderProgram("scene2_293370.vsh", "scene2_293370.fsh");
    ...
    g_osSplatShader = new ShaderProgram("scene3_293370.vsh", "scene3_293370.fsh");
    ...
    g_osBlendSplatShader = new ShaderProgram("scene4_293370.vsh", "scene4_293370.fsh");
